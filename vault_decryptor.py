...
class VaultDecryptorGUI:
    ...
    def create_widgets(self):
        ...
        # Load button
        self.load_button = ttk.Button(vault_frame, text="Load Vault Data", command=self.load_vault_data)
        ...
        self.decrypt_button = ttk.Button(password_frame, text="Decrypt", command=self.decrypt_vault)
